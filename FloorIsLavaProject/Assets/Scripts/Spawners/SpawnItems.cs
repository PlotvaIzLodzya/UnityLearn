...
public class SpawnItems : MonoBehaviour
{
    ...
    private Vector3 SpawnOnPlatforms(int _magicDivider)
    {
        ...
        int _index = Random.Range(0, _platformsPos.Length / _magicDivider); // this _magicDivider give me opprtunity to spawn thing in the end of line. For example if _magicDivider = 2 it will get all pillars in second half of the line, i just hope it will work in all situation xD, the more divider is the closes to the end of the line it will pick pillars
